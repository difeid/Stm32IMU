...
float madgwickBeta = betaDef;			// 2 * proportional gain (Kp)
 ...
 */
void MadgwickAHRSupdate(float g[3], float a[3], float m[3], float samplePeriod,
 ...
 * @retval None; quaternion[4]
 */
void MadgwickAHRSupdateIMU(float g[3], float a[3], float samplePeriod,
                           /*out*/ float quaternion[4])
{
	float gx=g[0];
	float gy=g[1];
